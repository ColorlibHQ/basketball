 ...
 */
    ...
    $copyRight = !empty( basketball_opt( 'basketball_footer_copyright_text' ) ) ? basketball_opt( 'basketball_footer_copyright_text' ) : $copyText;
    $footer_class = basketball_opt( 'basketball_footer_widget_toggle' ) == 1 ? 'footer-area' : 'no_widget';

    ?>

    <!-- footer part start-->
    <?php
        if( basketball_opt( 'basketball_footer_widget_toggle' ) == 1 ) {
    ?>
