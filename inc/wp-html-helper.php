...
// image default alt
if( !function_exists( 'basketball_img_default_alt' ) ){
	function basketball_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'basketball_img_tag' ) ){
	function basketball_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = basketball_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'basketball_anchor_tag' ) ){
	function basketball_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'basketball_heading_tag' ) ){
	function basketball_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'basketball_paragraph_tag' ) ){
	function basketball_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'basketball_other_tag' ) ){
	function basketball_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'basketball_button_element ' ) ){
	function basketball_button_element( array $args ){
