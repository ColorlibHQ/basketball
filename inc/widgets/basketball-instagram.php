...
----------------------------------------*/
class basketball_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('basketball_instagram_photo',esc_html__('[ BASKETBALL ] Intagram Photo','basketball'),array(
			'description' => esc_html__('BASKETBALL Instagram Photo Widget','basketball'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'basketball');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'basketball'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'basketball'); ?></label>
...
if(!function_exists('basketball_instagram_widgets')):
	function basketball_instagram_widgets(){
		register_widget('basketball_instagram_photo');
	}
	add_action('widgets_init','basketball_instagram_widgets');
endif;
