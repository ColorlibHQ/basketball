(function( $ , api){
    ...
    api.section( 'basketball_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'basketball_about_section' , function( section ){
    ...
    api.section( 'basketball_blog_section' , function( section ){
    ...
    api.section( 'basketball_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-basketball_contact_custom_formshortcode'),
                selector = $('#_customize-input-basketball_contact_formshortcode');
    ...
    // General section
    api.section( 'basketball_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#basketball_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-basketball_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-basketball_preloader_color' );
            ...
            var $backtotop          = $( '#basketball_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-basketball_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-basketball_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'basketball_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#basketball_footer_widget_toggle');
